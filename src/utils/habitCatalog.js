...
export const HABIT_CATALOG = [
  // ─── Body · Joint / mobility ───
  {
    ...
    description: "缓解久坐 / 看屏幕造成的颈部紧张。每个方向慢慢做，不弹动。",
    descriptionEn: "Releases neck tension from sitting and screen time. Move slowly, don't bounce.",
    tutorial: [
      "肩膀放下，不耸肩",
      "下颌微收，慢慢前屈 — 下巴向胸前靠，保持 5 次呼吸",
      "回中，向左侧屈（耳朵靠肩，肩不要抬起）— 5 次呼吸",
      "回中，向右侧屈 — 5 次呼吸",
      "慢慢回正，不要快速甩头",
    ],
    tutorialEn: [
      "Shoulders down, not shrugged",
      "Chin tucked, slowly bend forward — chin toward chest, hold for 5 breaths",
      "Back to center, lean left (ear toward shoulder, don't lift shoulder) — 5 breaths",
      "Back to center, lean right — 5 breaths",
      "Return slowly — don't snap the head back",
    ],
  ...
  },
  {
    ...
    description: "猫牛 + 简单流程，唤醒一晚上不动的脊柱。",
    descriptionEn: "Cat-cow plus simple flow, to wake up a spine that hasn't moved all night.",
    tutorial: [
      "四点支撑（手在肩膀正下方，膝盖在髋部正下方）",
      "吸气，腹部下沉、抬头看前 — 牛式",
      "呼气，背部拱起、下巴贴胸 — 猫式",
      "随呼吸来回，做 5-10 次",
      "结束可以坐回脚跟做婴儿式休息",
    ...
    tutorialEn: [
      ...
      "Exhale, arch back, chin to chest — cat",
      "Follow your breath, 5–10 cycles",
      "Optional: sit back on heels into child's pose to finish",
    ],
  ...
  // ─── Body · Strength ───
  {
    ...
    description: "下肢最经济的基础动作。重点在脚踝灵活、膝盖跟脚尖同向。",
    descriptionEn: "The most efficient lower-body basic. Focus on ankle mobility and tracking knees over toes.",
    tutorial: [
      "两脚与肩同宽或稍宽，脚尖略向外",
      "髋部先后坐（像坐椅子），不是膝盖先前推",
      "膝盖方向跟脚尖一致，不要内扣",
    ...
    tutorialEn: [
      "Feet shoulder-width or slightly wider, toes turned out a bit",
      "Hips move back first (like sitting in a chair), not knees pushing forward",
      "Knees track over toes — don't let them cave in",
      "Squat to a comfortable depth — no need to force going lower",
      "Stand up by driving through heels and squeezing glutes",
    ],
  ...
  },
  {
    ...
    description: "上肢和核心一起练。起步可以从墙俯卧 → 跪姿 → 全俯卧。",
    descriptionEn: "Trains upper body + core together. Progress: wall push-up → knee → full.",
    tutorial: [
      "手比肩稍宽，手指张开",
      "身体从头到脚跟成一条直线（核心收紧、不要塌腰）",
      "肘部与身体约 45°（不要完全外展）",
      "下放到胸距地面约一拳，再推起",
      "做不动时改跪姿继续，不要把动作做歪",
    ],
    tutorialEn: [
      ...
      "Body in a straight line from head to heels (core braced, no sagging)",
      "Elbows about 45° from body (not flared straight out)",
      "Lower until chest is about a fist from the floor, then push back up",
      "If form breaks, drop to knees instead of grinding through bad reps",
    ],
  ...
  },
  {
    ...
    description: "等长收缩练核心 + 肩稳定。要点是身体成一条直线，质量比时间重要。",
    descriptionEn: "Isometric core + shoulder stability. The line of the body matters more than the seconds.",
    tutorial: [
      "前臂着地，肘在肩膀正下方",
      "脚尖踩地，膝盖离地，腿伸直",
      "腹部内收 + 臀部夹紧（不要塌腰、也不要翘臀）",
      "想象头顶被向前拉，让脖子放松",
      "感到塌腰就停 — 形式比时间重要",
    ],
    tutorialEn: [
      "Forearms down, elbows directly under shoulders",
      "Toes on the floor, knees lifted, legs straight",
      "Brace abs + squeeze glutes (no sagging hips, no piked butt)",
      "Imagine the crown of your head being pulled forward, let your neck relax",
      "Stop the moment the hips sag — form first, time second",
    ],
  ...
  // ─── Body · Cardio ───
  {
    ...
    description: "中低强度持续运动。能说话但不能唱歌的速度。",
    descriptionEn: "Sustained low-to-moderate cardio. Pace = could talk but not sing.",
    tutorial: [
      "目标心率约最大心率的 60-70%（≈ 180 − 年龄）",
      "用鼻子吸气、嘴巴呼气；如果开始喘说明太快",
      "可以正常对话、但无法唱整首歌 — 这就是 Zone 2",
      "户外快走 / 慢跑 / 椭圆机都可以",
      "理想 30 分钟以上；先从能做的时长开始",
    ],
    tutorialEn: [
      "Target heart rate ≈ 60–70% of max (rough max ≈ 180 − your age)",
      "Breathe in through the nose, out through the mouth — if you're gasping, slow down",
      "You can talk normally but can't sing a whole song — that's Zone 2",
      "Brisk outdoor walk, easy jog, or elliptical all work",
      "30+ minutes is ideal; start with what you can hold today",
    ],
  ...
  // ─── Body · Neuro (breathing) ───
  {
    ...
    description: "副交感激活的呼吸法。睡前或焦虑高时用。",
    descriptionEn: "Parasympathetic-activating breath. Use it pre-sleep or when anxiety spikes.",
    tutorial: [
      "舌尖轻抵上颚（贴在门牙后方）",
      "嘴巴呼气 — 发出「呼」的声音，把肺里气体全部排空",
      "闭嘴用鼻子吸气 4 秒",
      "屏息 7 秒",
      "嘴巴呼气 8 秒（同样发「呼」声）",
      "重复 4 个循环；练习熟后可加到 8 个",
    ],
    tutorialEn: [
      "Tongue tip resting lightly on the roof of the mouth, behind upper teeth",
      "Empty lungs with a whoosh exhale through the mouth",
      "Close mouth, inhale through the nose for 4 seconds",
      "Hold the breath for 7 seconds",
      "Exhale through the mouth (whoosh) for 8 seconds",
      "Repeat for 4 cycles; once comfortable, build up to 8",
    ],
  ...
  },
  {
    ...
    description: "练习「注意到走神」 — 不是练习不走神。",
    descriptionEn: "The practice is noticing when the mind wanders — not preventing it from wandering.",
    tutorial: [
      "舒适地坐着 — 椅子或盘腿都行，背部不要瘫着",
      "把注意力放在呼吸上（鼻尖 / 胸口 / 腹部 — 选一处）",
      "走神是必然的；发现走神时，温柔地把注意力带回呼吸",
      "不要批评自己「又走神了」 — 注意到本身就是练习",
      "ADHD 友好做法：用引导音频（Calm / Insight Timer）",
    ],
    tutorialEn: [
      "Sit comfortably — chair or cross-legged, just don't slump",
      "Place attention on the breath (nose / chest / belly — pick one)",
      "Mind wandering is inevitable; when you notice, gently bring it back to the breath",
      "Don't scold yourself for drifting — noticing IS the practice",
      "ADHD-friendly: use a guided audio (Calm / Insight Timer) rather than silence",
    ],
