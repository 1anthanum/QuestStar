...
export default function Header({ levelInfo, xp, streak, completedSteps, onOpenSettings }) {
  return (
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="animate-pulse-glow rounded-full">
              <ProgressRing progress={levelInfo.progress} size={48} stroke={4} id="header-ring">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="text-center px-3 py-1.5 rounded-xl bg-amber-50/80">
              <div className="text-lg font-black text-amber-500">{xp}</div>
              <div className="text-[9px] text-amber-400 font-semibold uppercase tracking-wide">XP</div>
            </div>
